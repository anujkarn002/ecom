  ...
  switch (type) {
    ...
    case ADD_PRODUCT:
      try {
        ...
        const key = yield call(firebase.generateKey, 'products');
    ...
    case EDIT_PRODUCT:
      try {
        ...
        if (image.constructor === File && typeof image === 'object') {
          yield call(firebase.deleteImage, payload.id, 'products');
          const downloadURL = yield call(firebase.storeImage, payload.id, 'products', image);
